...
Let us start by creating a package calledrk_tutorial. Make sure you are in the source folder of a catkin workspace and run:
...
Copy over the demo analysis engine from the RoboKudo core package (note the renaming of the file):
