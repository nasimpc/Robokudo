...
4. Send the answer through the ROS 2 `QueryHandler` helper.
...
For validation, cancellation, and preemption, use the advanced query pattern in [[sources/advanced-query-handling|Advanced Query Handling]].
